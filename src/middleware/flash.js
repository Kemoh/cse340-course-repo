/**
 * Flash Message Middleware provides temporary message that survives redirects but is consumed on render.
 * 
...
/** -----------------------------------------------------------
 ...
 const flashMiddleware = (req, res, next) => {
    req.flash = function(type, message) {
        ...
        // SETTING: Two args means we're storing a new message
        if(type && message) {
        ...
        // GETTING ONE TYPE: One arg means retrieve messages of that type 
        if(type && !message) {
        ...
        // GETTING ALL: No args means retrieve all types
